...
- [Whisk](https://github.com/nathan-poncet/whisk) - Keyboard-first clipboard manager with a Paste-style panel, pins, search operators, paste stack and rich previews. :large_orange_diamond:
