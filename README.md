...
- [Lucid](https://github.com/braedonsaunders/lucid) - Real-time AI video super-resolution for Apple silicon Macs that enhances browser video in place with local models.
